...
namespace BibliographyMaker
{
	public partial class aboutdialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget BibliographyMaker.aboutdialog
			this.Name = "BibliographyMaker.aboutdialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child BibliographyMaker.aboutdialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child BibliographyMaker.aboutdialog.ActionArea
